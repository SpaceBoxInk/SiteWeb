...
<?php
    ...
    {
?>
    <meta http-equiv="refresh" content="1; url=http://www.spaceboxink.fr/" /> <!-- Redirection vers la page d'accueil du site si on a entré son e-mail. -->
...
?>
    ...
    <meta http-equiv="refresh" content="25; url=http://www.spaceboxink.fr/" /> <!-- Redirection vers la page d'accueil du site si on tarde trop à entrer son e-mail. -->
...
elseif($_GET['tru']==2) // Sinon, si la variable $_GET['tru'] est égale à 2.
    ...
    // mysql_select_db("db");
    $email_mail = escapeString($_COOKIE['email']);
    $email_entre = escapeString($_POST['email']);
